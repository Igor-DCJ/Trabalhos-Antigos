        ...
        <div class="intro">
          ...
          <div class="intro-text left-0 text-center bg-faded p-5 rounded">
			...
			if(isset($_GET['deletar'])){ //deletar cliente 
				$sql="DELETE FROM produzido WHERE id = '".$_GET['deletar']."'";
			...
			{ 
				echo"<table border=1> 
					...
					{ 
						...
						echo "
						<td>
						<a href=\"".$_SERVER['PHP_SELF']."?deletar=".$row["id"]."\"><img src=\"img/delete.png\" height=\"20\" width=\"20\"></a></td>";
            ...
            <div class="intro-button mx-auto">
              <a class="btn btn-primary btn-xl" href="inserircoleta.php" value="novacoleta">Nova Coleta</a>
            </div>
